 ...
 */
class PartnerProduct extends CI_Controller {
    ...
    public function getUserData() {
        ...
        return $this->admin_model->getUserdata($this->session->userdata('is_partner'), $email);
    }
    ...
    public function index($store_id, $shop_section_id) {
        ...
        $this->load->view('admin/partner-product/viewProduct');
    ...
    public function get_product_wrapper($store_id, $shop_section_id) {
        ...
        $content_wrapper = $this->load->view('admin/partner-product/product-wrapper', $data, true);
    ...
    public function add_product($store_id, $shop_section_id, $product_id = null) {
        ...
        $this->load->view('admin/commons/header', $data);
        $this->load->view('admin/commons/partner-sidebar', $data);
        $this->load->view('admin/partner-product/addProduct');
        $this->load->view('admin/commons/footer');
    }
    ...
    public function doAddProduct($store_id, $shop_section_id) {
        ...
        if ($result) {
            ...
            $this->output->set_output(json_encode(['result' => 1, 'msg' => 'Detail Added Sucessfully', 'url' => base_url('partner/partnerProduct/' . $store_id . '/' . $shop_section_id)]));
            return FALSE;
        } else {
            $this->output->set_output(json_encode(['result' => -1, 'msg' => 'Product did not added sucessfully.', 'url' => base_url('partner/partnerProduct/' . $store_id . '/' . $shop_section_id)]));
            return FALSE;
        }
    }
    ...
    public function doEditProduct($store_id, $shop_section_id, $product_id) {
        ...
        if ($result) {
            ...
            $this->output->set_output(json_encode(['result' => -1, 'msg' => 'No changes were made.', 'url' => base_url('partner/partnerProduct/' . $store_id . '/' . $shop_section_id)]));
            return FALSE;
        }
    }
    ...
    public function view_product_sku($store_id, $shop_section_id, $product_id) {
        ...
        $this->load->view('admin/commons/header', $data);
        $this->load->view('admin/commons/partner-sidebar', $data);
        $this->load->view('admin/partner-product-sku/viewProductSku');
        $this->load->view('admin/commons/footer');
    }
    ...
    public function get_product_sku_wrapper($store_id, $shop_section_id, $product_id) {
        ...
        $content_wrapper = $this->load->view('admin/partner-product-sku/product-sku-wrapper', $data, true);
        $this->output->set_output(json_encode(['result' => 1, 'content_wrapper' => $content_wrapper]));
        return FALSE;
    }
    ...
    public function add_product_sku($store_id, $shop_section_id, $product_id, $product_sku_id = null) {
        ...
        $this->load->view('admin/commons/header', $data);
        $this->load->view('admin/commons/partner-sidebar', $data);
        $this->load->view('admin/partner-product-sku/addProductSku');
        $this->load->view('admin/commons/footer');
    }
    ...
    public function doAddProductSku($store_id, $shop_section_id, $product_id) {
        ...
        if ($result) {
            ...
            $this->output->set_output(json_encode(['result' => 1, 'msg' => 'Detail Added Sucessfully', 'url' => base_url('partner/view-product-sku/' . $store_id . '/' . $shop_section_id . '/' . $product_id)]));
            return FALSE;
        } else {
            $this->output->set_output(json_encode(['result' => -1, 'msg' => 'Product Sku did not added sucessfully.', 'url' => base_url('partner/view-product-sku/' . $store_id . '/' . $shop_section_id . '/' . $product_id)]));
            return FALSE;
        }
    }
    ...
    public function get_product_sku_image_wrapper($product_sku_id) {
        ...
        $content_wrapper = $this->load->view('admin/partner-product-sku/product-sku-image-wrapper', $data, true);
        $this->output->set_output(json_encode(['result' => 1, 'content_wrapper' => $content_wrapper]));
        return FALSE;
    }
    ...
    public function doEditProductSku($store_id, $shop_section_id, $product_id, $product_sku_id) {
        ...
        $this->output->set_output(json_encode(['result' => 1, 'msg' => 'Detail Updated Sucessfully', 'url' => base_url('partner/view-product-sku/' . $store_id . '/' . $shop_section_id . '/' . $product_id)]));
        return FALSE;
    }
