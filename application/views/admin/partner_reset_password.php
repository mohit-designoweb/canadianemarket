                    ...
                    <div class="col-lg-4  bg-white">
                        <div class="row align-items-center m-h-100">
                            <div class="mx-auto col-md-8">
								...
								<form class="needs-validation" action="<?php echo base_url('admin/partner/update_forgot_password'); ?>" id="update-forgot-password">
                                    <div class="form-row">
...
<!--                                            <label for="email">Email</label>-->
                                    ...
                                    <input type="hidden" name="partnerid" value="<?php echo $partner_id;?>" />
