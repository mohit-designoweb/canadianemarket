                    ...
                    <div class="col-lg-4  bg-white">
                        <div class="row align-items-center m-h-100">
                            <div class="mx-auto col-md-8">
                                ...
                                <h3 class="text-center p-b-20 fw-400">Courier Login</h3>
                                <div id="error_msg"></div>
                                <form class="needs-validation" action="<?php echo base_url('courier/checkLogin'); ?>" id="common-form">
                                    <div class="form-row">
                                ...
                                <p class="text-right p-t-10">
                                    <a href="<?php echo base_url('courier/forgot-password');?>" class="text-underline">Forgot Password?</a>
                                </p>
                            </div>
