    ...
    <div class="container pull-up">
        <div class="row">
            <div class="col-12" id="content-wrapper" data-url="">
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="<?php if(empty($content['content'])){echo base_url('admin/addPrivacyPageContent');} else{
                         echo base_url('admin/editPrivacyPageContent/'.$content['content_id']);   
                        }?>" id="common-form" >
