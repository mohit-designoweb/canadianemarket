                ...
                <tbody>
                    ...
                    if (!empty($menus)) {
                        ...
                        foreach ($menus as $menu) {
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><?php echo $menu['restaurant_name']; ?></td>
								...
								<?php if ($menu['is_active'] == 'Active') {
                                        ...
                                        <?php }
                                        ?>
                                    <a href="<?php echo base_url('admin/restaurant-menu/' . $menu['restaurant_id'] . '/' . $menu['menu_category_id']); ?>" data-toggle="tooltip" data-placement="top" title data-original-title="Add Menu" class="btn btn-info btn-sm">Menu <i class="fe fe-menu"></i></a>
                                    <a href="<?php echo base_url('admin/restaurant-menu-category/' . $menu['restaurant_id'] . '/' . $menu['menu_category_id']); ?>" data-toggle="tooltip" data-placement="top" title data-original-title="Edit Category" class="btn btn-success btn-sm">Edit <i class="fe fe-edit"></i></a>
