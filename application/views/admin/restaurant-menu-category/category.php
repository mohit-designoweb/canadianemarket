<section class="admin-content">
        ...
        <div class="container  m-b-30">
            <div class="row">
                <div class="col-12 text-white p-t-40 p-b-90">
                    ...
                    <h4><a href="<?php echo base_url('admin/adminRestaurant'); ?>">Restaurant</a> / Restaurant Menu Category</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container pull-up">
        <div class="row">
            <div class="col-8" id="content-wrapper" data-url="<?php echo base_url('admin/get-restaurant-menu-category-wrapper/'.$restaurant_id); ?>"></div>
            <div class="col-4">
