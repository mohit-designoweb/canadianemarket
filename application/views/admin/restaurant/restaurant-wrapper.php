                        ...
                        foreach ($restaurants as $restaurant) {
                            ...
                            <tr>
								...
								<?php if ($restaurant['is_active'] == 'Active') { ?>
                                    ...
                                    <a href="<?php echo base_url('admin/addRestaurant/' . $restaurant['restaurant_id']); ?>" data-toggle="tooltip" data-placement="top" title="Edit Store" class="btn btn-success btn-sm">Edit <i class="fe fe-edit"></i></a>
