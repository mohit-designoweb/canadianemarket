                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                <a href="<?php echo base_url('partner/partner-restaurant-menu/' . $restaurant_id . '/' . $menu_category_id); ?>" class="btn btn-primary">View Menu</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        if (!empty($menu)) {
                            echo base_url('partner/doEditPartnerRestaurantMenu/' . $restaurant_id . '/' . $menu_category_id . '/' . $menu['menu_id']);
                        } else {
                            echo base_url('partner/doAddPartnerRestaurantMenu/' . $restaurant_id . '/' . $menu_category_id);
                        }
                        ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="menu_name">Name <i style="color:red;">*</i></label>
