...
//                                        var_dump($price);
//                                        var_dump($order_detail['tax']);
//                                        var_dump($order_detail['service_fee']);
//                                        var_dump($order_detail['delivery_charge']); 
                                    }
                                    ?>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td colspan="2" class="text-right">
                                            <?php //echo $price;  ?>
                                            $ <?php
                                            echo $grand_total = number_format($price + $order_detail['tax'] + $order_detail['service_fee'] + $order_detail['delivery_charge'], 2);
