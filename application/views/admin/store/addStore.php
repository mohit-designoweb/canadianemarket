                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                ...
                                ?>
                                <a href="<?php echo $view_url; ?>" class="btn btn-primary">View Store</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" id="image-common-form" action="<?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="image_url">Category <i style="color:red;">*</i></label>
...
<!--                                </div>
                                <div class="col-md-4">-->
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(['name' => 'delivery_charge', 'id' => 'delivery_charge', 'class' => 'form-control'], isset($store['delivery_charge']) ? $store['delivery_charge'] : ''); ?>   
                                    </div>
                                </div>
                            </div>
