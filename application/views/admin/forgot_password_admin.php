                    ...
                    <div class="col-lg-4  bg-white">
                        <div class="row align-items-center m-h-100">
                            <div class="mx-auto col-md-8">
                                ...
                                <form class="needs-validation" action="<?php echo base_url('admin/forgot_password_checked'); ?>" id="common-form-forgot-password">
                                    <div class="form-row">
...
<!--                                <p class="text-right p-t-10">
                                    <a href="<?php echo base_url('admin/admin/forgot_password');?>" class="text-underline">Forgot Password?</a>
                                </p>-->
                            </div>
                        </div>
                    </div>
