            ...
            <div class="col-12">
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                <a href="<?php echo base_url('partner/view-product-sku/' . $store_id . '/' . $shop_section_id . '/' . $product_id); ?>" class="btn btn-primary">View SKU</a>
                            </div>
                        </div>
                    </div>
                    <p id="error-msg"></p>
                    <div class="card-body">
                        ...
                        if (!empty($product)) {
                            echo base_url('partner/doEditProductSku/' . $store_id . '/' . $shop_section_id . '/' . $product_id . '/' . $product['product_sku_id']);
                        } else {
                            echo base_url('partner/doAddProductSku/' . $store_id . '/' . $shop_section_id . '/' . $product_id);
                        }
                        ?>">
                            <div class="row">
                                <div class="col-md-4">
                                ...
                                ?>
                                 <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <input type="hidden" name="mapping_id[]" value="<?php echo $sku_mapping[$i]['sku_mapping_id']; ?>"/>
                                        <?php
                                        }
                                        ?>
                            ...
                            <?php if(!empty($product['product_sku_id'])){
                            ?>
                            <div class="row" id="content-wrapper" data-url="<?php echo base_url('partner/get-product-sku-image-wrapper/'.$product['product_sku_id']) ?>">
                            </div>
                            <?php
                            }  ?>
