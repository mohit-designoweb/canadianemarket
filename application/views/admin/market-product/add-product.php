                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                <a href="<?php echo base_url('admin/adminMarket'); ?>" class="btn btn-primary">View Product</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        if (!empty($product)) {
                            echo base_url('admin/doEditMarketProduct/' . $product['market_place_product_id']);
                        } else {
