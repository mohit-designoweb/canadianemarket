        ...
        <div class="container  m-b-30">
            <div class="row">
                <div class="col-12 text-white p-t-40 p-b-90">
                    <h4><a href="<?php echo base_url('admin/shop-section') ?>">Shop Section</a> / Product</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card m-b-30">
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                <a href="<?php echo base_url('admin/adminProduct/' . $store_id . '/' . $shop_section_id); ?>" class="btn btn-primary">View Store</a>
                            </div>
                        </div>
                    </div>
                    <p id="error-msg"></p>
                    <div class="card-body">
                        ...
                        if (!empty($product)) {
                            echo base_url('admin/doEditProduct/' . $store_id . '/' . $shop_section_id . '/' . $product['product_id']);
                        } else {
                            echo base_url('admin/doAddProduct/' . $store_id . '/' . $shop_section_id);
                        }
                        ?>">
