                            ...
                            <tr>
                                ...
                                <td>
								 <?php if ($category['is_active'] == 'Active') {
                                        ...
                                        <?php }
                                        ?>
                                    <a href="<?php  echo base_url('admin/storeCategory/' . $category['category_id']); ?>" data-toggle="tooltip" data-placement="top" title="Edit Category" class="btn btn-success btn-sm">Edit <i class="fe fe-edit"></i></a>
