                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-2 offset-7">
                                <a href="<?php echo base_url('partner/partnerRestaurant'); ?>" class="btn btn-primary">View Restaurant</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        if (!empty($restaurant)) {
                            echo base_url('admin/doEditPartnerRestaurant/' . $restaurant['restaurant_id']);
                        } else {
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_textarea(['name' => 'speciality', 'id' => 'speciality', 'rows' => '5', 'class' => 'form-control'], isset($restaurant['speciality']) ? $restaurant['speciality'] : '') ?>   
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(['name' => 'latitude', 'id' => 'latitude', 'class' => 'form-control'], isset($restaurant['latitude']) ? $restaurant['latitude'] : '') ?>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="longitude">Longitude</label>
                                        <?php echo form_input(['name' => 'longitude', 'id' => 'longitude', 'class' => 'form-control'], isset($restaurant['longitude']) ? $restaurant['longitude'] : '') ?>
                                    </div>
                                </div>
                            </div>
