                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        if (!empty($charges)) {
                            ...
                            echo base_url('admin/doEditStoreDeliveryCharges/' . $charges['store_delivery_charges_id']);
                        } else {

                            echo base_url('admin/doAddStoreDeliveryCharges');
                        }
                        ?>">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="store_distance">Store Distance</label>
                                        <?php echo form_input(['name' => 'store_distance', 'id' => 'store_distance', 'class' => 'form-control', 'placeholder' => 'Store Distance'], isset($charges['store_distance']) ? $charges['store_distance'] : ''); ?>    
                                    </div>
