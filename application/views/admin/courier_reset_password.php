                    ...
                    <div class="col-lg-4  bg-white">
                        <div class="row align-items-center m-h-100">
                            <div class="mx-auto col-md-8">
                                ...
                                <form class="needs-validation" action="<?php echo base_url('admin/courier/update_forgot_password'); ?>" id="update-forgot-password">
                                    <div class="form-row">   
                                        <div class="form-group floating-label col-md-12">
                                         ...
                                         <div class="form-group floating-label col-md-12">
                                          <!-- <label for="password">Confirm Password</label> -->
                                            <input type="password" name="conf_password" id="conf_passwords" placeholder="Confirm Password" class="form-control "  >
                                        </div>
                                    </div>
                                    <input type="hidden" name="courierid" value="<?php echo $courier_id;?>" />
                                    <button type="submit" class="btn btn-primary btn-block btn-lg">Change</button>
                                </form>
<!--                                <p class="text-right p-t-10">
                                    <a href="<?php echo base_url('admin/partner/forgot_password');?>" class="text-underline">Forgot Password?</a>
                                </p>-->
                            </div>
                        </div>
                    </div>
