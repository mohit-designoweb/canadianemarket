    ...
    <div class="container">
        ...
        <div class="slider2 slick restaurantslider">
            ...
            <div class="store_banner_in boxs">
                <img src="<?php echo base_url('/uploads/slider/' . $slider['image_url']); ?>" class="img-responsive storeimghide" alt="banner_image">
                    ...
                    <div class="brows_store_lft boxs">
                        <div class="categories boxs">
							...
							<div class="categories_btm boxs">
                                <?php
                                $i = 1;
                                foreach ($nameAndCoutns as $report) {
                                    ?>
                                    <a href="<?php echo base_url('restaurant/get-restaurant-wrapper/' . $report['restaurant_category_id'] . '/0'); ?>" class="common-menu <?php
                                    if ($i == 1) {
                                        echo 'active';
                                    }
                                    ?>"><?php echo $report['category_name']; ?><span>(<?php echo $report['total'];?>)</span></a>
                                       <?php
                                       $i++;
                                   }
                                   ?>
                    ...
                    <div class="browsAll_store_lft boxs">
                        <div class="browsAll_store restAll_s boxs">
                            <div class="brows_head boxs">
                                ...
                                <h2>Restaurants <span id="store_cnt"></span></h2>
                            </div>
