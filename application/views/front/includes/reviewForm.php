 <form name="rate_review" id="rate_review" action="<?php echo base_url('user/doAddRateReview/'. $product_id);?>" method="post">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title text-center text-success"><strong>Your review</strong></h4>
        </div>
        <div class="modal-body">
            <div class="descipt product_descipt reviewbx" >
            <!--<h2>Reviews</h2>-->
