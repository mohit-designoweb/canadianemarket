                                <?php if(!empty($cancelled_store_orders)) {
                                    foreach($cancelled_store_orders as $cancelled_store_order){
                                ?>
                                <div class="orderitem boxs">
                                    <div class="orderdetails boxs">
                                        <div class="orderid">
                                            <a href="javascript:void(0)" class="slidehover"><?php if(!empty($cancelled_store_order['order_unique_id'])){ echo $cancelled_store_order['order_unique_id']; }?></a>
                                            <span class="redcolor"><?php if(!empty($active_store_order['status']) == 'cancel'){ echo "Cancelled"; }?></span>
                                        </div>
                                        <div class="orderhelp">
                                    ...
                                    <?php foreach($cancelled_store_order['ordered_product'] as $ordered_product){ ?>
...
<!--                                                    <a href="javascript:void(0)" class="cancelitem"><img src="<?php echo base_url('assets');?>/img/cross_red.png" alt="cross_red">Cancel</a>
                                    ...
                                    <?php } ?>
                                    <p class="pull-right"><strong>Order Total: </strong><span><?php echo '$'.$cancelled_store_order['total_amount'];?></span></p>
                                </div>
                                <?php }  } ?>
                                
                                <?php if(!empty($cancelled_restaurant_orders)) {
                                    foreach($cancelled_restaurant_orders as $cancelled_restaurant_order){
                                ?>
                                <div class="orderitem boxs">
                                    <div class="orderdetails boxs">
                                        <div class="orderid">
                                            <a href="javascript:void(0)" class="slidehover"><?php if(!empty($cancelled_restaurant_order['unique_order_id'])){ echo $cancelled_restaurant_order['unique_order_id']; }?></a>
                                            <span class="redcolor"><?php if(!empty($cancelled_restaurant_order['order_status']) == 'cancel'){ echo "Cancelled"; }?></span>
                                        </div>
                                        <div class="orderhelp">
                                            <a href="javascript:void(0)"><img src="<?php echo base_url('assets');?>/img/help.png" alt="help" class="img-responsive">Need Help</a>
                                        </div>
                                    ...
                                    <div class="bd_btm boxs"></div>
                                    <?php foreach($cancelled_restaurant_order['restaurant_menudetail'] as $restaurant_menudetail){ ?>
                                    <div class="cart_items boxs">
                                        ...
                                        <div class="item_details">
                                            <div class="id_lft boxs">
                                                <h5><?php echo $restaurant_menudetail['menu_name'];?><span><?php echo $cancelled_restaurant_order['restaurant_name'];?></span></h5>
...
<!--                                                    <a href="javascript:void(0)" class="cancelitem"><img src="<?php echo base_url('assets');?>/img/cross_red.png" alt="cross_red">Cancel</a>
                                    ...
                                    <?php } ?>
                                    <p class="pull-right"><strong>Order Total: </strong><span><?php echo '$'.$cancelled_restaurant_order['total_amount'];?></span></p>
                                </div>
                                <?php }  } ?>